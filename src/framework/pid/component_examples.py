...
def _ensure_example_component_tags(
    scene: PIDComponentScene,
) -> PIDComponentScene:
    """Assign deterministic engineering tags to example pipes/valves."""
    tagged_types = (
        PipeRunComponent,
        GateValveComponent,
        ControlValveComponent,
...
def horizontal_separator_component_scene() -> PIDComponentScene:
    scene = PIDComponentScene(
        ...
        assumptions=[
            (
                ...
                "schematic P&ID geometry."
            ),
            (
                "Internal vessel details "
                "are symbolic and not "
                "fabrication-grade."
            ),
        ],
    )
    ...
    return _ensure_example_component_tags(
        scene
    )
...
def available_component_examples() -> dict[
    str,
    Callable[
        [],
        PIDComponentScene,
