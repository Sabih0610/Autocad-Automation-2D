...
def test_cad3d_approve_token_is_consumed_on_success_and_cannot_replay(client, monkeypatch) -> None:
    """`_CAD3D_CACHE` never expires entries on its own — before this fix, the
